...
public final class HelloWorld extends PicoCommandHandler {
    ...
    @Inject
    public HelloWorld(ApplicationPropertyLoader applicationPropertyLoader, MyUtil myUtil, Cache cache, ThreadPoolWrapper threadPoolWrapper, SessionFactoryWrapper sessionFactoryWrapper) {
